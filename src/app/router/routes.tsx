...
export const routerConfig = [
  ...
  { path: '/activate-account', element: <Navigate to="/activate" replace /> },
  ...
  { path: '/app/activate', element: <Navigate to="/activate" replace /> },
  { path: '/app/activate-account', element: <Navigate to="/activate" replace /> },
  {
    path: '/',
    element: (
      <ProtectedRoute>
