...
export function CeReportPrintPage() {
  ...
  return (
    <div className="rpt-page-wrap">
      ...
      {/* ===== PAGE 3 — Project & compliance summary ===== */}
      <section className="rpt-page">
        {header()}
        <div className="rpt-body">
      ...
      {/* ===== PAGE 5 — Dossier completeness checklist ===== */}
      <section className="rpt-page">
        {header()}
        <div className="rpt-body">
      ...
      {/* ===== PAGE 7 — Detailed weld inspections ===== */}
      <section className="rpt-page">
        {header()}
        <div className="rpt-body">
