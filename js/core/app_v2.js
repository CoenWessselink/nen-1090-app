(function(){
  ...
  const routeNames = {
    dashboard:'Dashboard', projecten:'Projecten', lascontrole:'Lascontrole', ce:'CE Dossier', instellingen:'Instellingen'
  };
  const base = '../layers/';
  function pageKey(){
  ...
  function mountShell(){
    ...
    if(content) document.getElementById('appPage').appendChild(content);
  }
